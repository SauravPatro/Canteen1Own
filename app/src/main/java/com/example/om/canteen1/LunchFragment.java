...
public class LunchFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        ref= FirebaseDatabase.getInstance().getReference().child("item").child("lunch");
        ref.keepSynced(true);
        mAuth=FirebaseAuth.getInstance();
        FirebaseRecyclerAdapter<ItemsPOJO,LunchFragment.UsersViewHolder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<ItemsPOJO, LunchFragment.UsersViewHolder>(
                ItemsPOJO.class,
                R.layout.card_layout,
                LunchFragment.UsersViewHolder.class,
                ref
        ) {
            @Override
            protected void populateViewHolder(LunchFragment.UsersViewHolder viewHolder, final ItemsPOJO model, final int position) {
                ...
                viewHolder.card.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if(mAuth.getCurrentUser()==null){
                            ...
                            new AddDialog(getContext(), model.getItemNo(),mAuth.getCurrentUser().getUid(),model.getName(),model.getPrice(),"lunch" );
                        }
                    }
                });
            }
