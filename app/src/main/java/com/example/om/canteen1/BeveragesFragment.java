...
public class BeveragesFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        ref= FirebaseDatabase.getInstance().getReference().child("item").child("beverages");
        ref.keepSynced(true);
        mAuth=FirebaseAuth.getInstance();
        FirebaseRecyclerAdapter<ItemsPOJO,BeveragesFragment.UsersViewHolder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<ItemsPOJO, BeveragesFragment.UsersViewHolder>(
                ItemsPOJO.class,
                R.layout.card_layout,
                BeveragesFragment.UsersViewHolder.class,
                ref
        ) {
            @Override
            protected void populateViewHolder(BeveragesFragment.UsersViewHolder viewHolder, final ItemsPOJO model, final int position) {
